...
/**
 * Class describing common variables for parallel threads to use.
 * It has two variables:
 *  - boolean hasCompositeNumber;
 *  - int currentIndex.
 * An interface gives user three methods to use these variables.
 */
public interface CommonVars {
    ...
    /**
     * Sets hasCompositeNumber flag with true. It signals that some thread found composite number in an array.
     */

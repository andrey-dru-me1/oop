...
public class ComplexMultiply extends Operation {
  ...
  public ComplexNumber calculate(@NotNull List<Value> operands) {
    if (operands.size() == 2) {
      if (operands.get(0) instanceof ComplexNumber complex1 && operands.get(
        ...
        return new ComplexNumber(complex1.getComplexNumber().multiply(complex2.getComplexNumber()));
      }
    }
